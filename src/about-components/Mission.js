  ...
  render() {
    return (
      <View>
        ...
        <Text style={{ color: '#1F195C', paddingTop: 10, paddingBottom: 5}}>Mission Statement</Text>
        <Text style={{ color: '#333333', fontSize: 12, lineHeight: 17,paddingBottom: 5 }}>{this.props.passedVal}</Text>
      </View>
    );
  }
}
