...
export default class Administator extends React.Component {

  render() {
    return (
      <View  style={{ alignItems: 'center', justifyContent:'center'}} textStyle={{color:'black'}} >
        {<Thumbnail square size={100} source={require('../images/administrator.png')}/>}
        <Text style={{fontSize: 10, textAlign: 'center'}}>Adminstrator{"'s\n"} Welcome</Text>
      </View>
    );
  }
}
